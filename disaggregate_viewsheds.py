...
def disaggregate_viewsheds_and_convert_to_polygons(raster_file, vector_file,
...
def run(input_folder, output_folder, viewshed_file_regex, viewsheds_per_file, overflow):
    ...
    for viewshed_file in (y for y in listdir(input_folder) if vs_re.match(y)):
        ...
        disaggregate_viewsheds_and_convert_to_polygons(infile, outfile, viewsheds_per_file, overflow)
